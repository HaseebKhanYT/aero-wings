      ...
      <div className="contact">
        ...
        <div className="contactNumber container my-5">
          <div className="row g-3 my-5 ">
            ...
            <div className="col-12 col-md-9 d-flex flex-column justify-content-center align-items-center">
              <div className="contactTextContainer">
                <div className="contactInfo text-center text-md-start ">{PHONE_WHATSAPP_DISPLAY}</div>
          ...
          <div className="row g-3 my-5">
            ...
            <div className="col-12 col-md-9 d-flex flex-column justify-content-center align-items-center">
              <div className="contactTextContainer">
                <div className="contactInfo text-center text-md-start ">{PHONE_LANDLINE}</div>
                <div className="contactText text-center text-md-start">
          ...
          <div className="row g-3  my-5">
            ...
            <div className="col-12 col-md-9 d-flex flex-column justify-content-center align-items-center">
              <div className="contactTextContainer">
                <div className="contactInfo text-center text-md-start ">{PHONE_AGENT}</div>
                <div className="contactText text-center text-md-start">
          ...
          <div className="row g-3 my-5">
            ...
            <div className="col col-md-9 d-flex flex-column justify-content-center align-items-center">
              <div className="contactTextContainer">
                <div className="contactInfo text-center text-md-start ">{EMAIL}</div>
                <div className="contactText text-center text-md-start">
            ...
            <div className="row">
              <div className="detailsContainer my-5 col-12 col-md-8">
                ...
                <div className="detailsDescription text-white">
                  ...
                  {ADDRESS.line2}, <br />
                  {ADDRESS.city}, <br />
                  {ADDRESS.region} {ADDRESS.postalCode} <br />
                  {ADDRESS.country} <br />
                </div>
              </div>
              <div className="detailsContainer my-5 col-12 col-md-4">
                ...
                <div className="detailsDescription text-white">
                  {HOURS.weekdays.split(", ")[0]} <br />
                  {HOURS.weekdays.split(", ")[1]} <br />
                  <br />
                  <br />
                  {HOURS.sunday.split(" (")[0]} <br />
                  ({HOURS.sunday.split(" (")[1]}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="contactDetailsTab2">
            ...
            <div className="detailsContainer my-3">
              <div className="mapContainer">
                <iframe
                  title="Aero Wings office location on Google Maps"
