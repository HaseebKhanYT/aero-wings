  ...
  return (
    <>
      <span className="socialIcons">
        <a className="socialIcon" href="https://www.facebook.com/kwaheeduddin">
          <img className="imageMain" src={FBiconLight} alt="fb" />
          <img className=" imageHover" src={FBiconColor} alt="fb" />
        </a>
        <a
          className="socialIcon"
          href="https://www.instagram.com/aerowingstravel/"
        >
        ...
        <a
          className="socialIcon"
          href="https://linkedin.com/company/aerowings-travel"
        >
          <img className="imageMain" src={LiconLight} alt="linkedin" />
          <img className="imageHover" src={LiconColor} alt="linkedin" />
        </a>
        <a className="socialIcon" href="https://wa.me/919177177011?text=Hello">
